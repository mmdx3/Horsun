  ...
  return (
    <div className="lg:w-[413px] w-[357px]  h-[427px] lg:h-[484px] rounded-xl lg:rounded-2xl gap-4 lg:gap-8 bg-white py-8 lg:px-[3.32rem] px-9 flex flex-col justify-center items-center register-form-shadow-box">
      <div className="flex flex-col justify-start items-end gap-2 w-[278px] lg:w-[306px]">
        ...
        <p className="text-[#494949] text-[12px]  lg:text-sm font-vazirFa ">
        ...
        <div className="flex flex-col justify-start items-end gap-2">
          ...
          <div
            className={`flex justify-center items-center w-[278px] lg:w-[306px] gap-1 rounded-lg border  ${
              errors.name ? "border border-red-500" : "border-[#dbdbdb]"
            }  py-0.5 px-2`}
          >
            <input
              type="text"
              {...register("name", { validate: useValidateName })}
              className="w-full h-10 rounded-lg  text-[#757575]  py-2 font-vazirFa text-sm px-0.5 border-none outline-none dir-rtl"
      ...
      <div className="w-[174px] h-[24px] font-dana font-medium text-sm cursor-pointer ">
        ...
        <Link href={"/auth/login"} className="font-bold text-[#d51f26] ">
          ورود{" "}
        </Link>
      </div>
    </div>
